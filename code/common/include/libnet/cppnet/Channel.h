...
public:
	...
	bool const getClientState() const { return m_bLegClient; }//only use in server for judge client

	void setClientState(bool bLegState) { m_bLegClient = bLegState; }//only use in server for judge client
